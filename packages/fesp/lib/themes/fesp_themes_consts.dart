...
const double SLIDE_PANEL_BORDER_RADIUS = 20;
...
Color FESP_SHADOW_COLOR(BuildContext context) => Theme.of(context).primaryColor;
Color FESP_ACTIVE_COLOR(BuildContext context) => Theme.of(context).focusColor;
Color FESP_EXPANSION_COLOR(BuildContext context) => FESP_ACTIVE_COLOR(context);
Color? FESP_TAB_BAR_COLOR(BuildContext context) =>
