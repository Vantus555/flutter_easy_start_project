...
import 'package:nedoctor_pro/project/views/other/my_app_multi_scroll.dart';
...
class MyAppTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MyAppMultiScroll(
      child: Table(
        defaultColumnWidth: FixedColumnWidth(width),
        border: TableBorder.all(
          color: AppConsts.TABLE_BORDER_DEFAULT_COLOR(context),
        ),
        children: children,
      ),
    );
    ...
    return TableCell(
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(
          vertical: AppConsts.MYAPP_TABLE_VERTICAL_DADDING,
          horizontal: AppConsts.MYAPP_TABLE_HORIZONTAL_DADDING,
        ),
        child: Align(
